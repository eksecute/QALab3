...
namespace laba3
{
    ...
    public class Tests
    {
        ...
        [Test(Description ="Test whether it marks the todo as completed")]
        ...
        public void Todo_DeletesOnlyCompletedTodos_OnRemoveCompletedTodos()
        {
            //Assert
            string[] todos = { "Stepa", "illya", "Max" };
            string[] todoToComplete = { "Max" };
            //Act
            page.AddSeveralTodos(todos);
            page.CompleteSeveralTodos(todoToComplete);
            page.ClearCompleted();
            //Assert
            Assert.IsTrue(page.ContainsTodo("Stepa"));
            Assert.IsTrue(page.ContainsTodo("illya"));
